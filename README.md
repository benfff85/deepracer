...
| 5   | calculate progress_reward           |            |                    | TODO Track progress                                                                                                                                                                                                                                                                                            |
...
| 101 | terminal_wheel_off_track_reward     | Absolute   | NA                 | Set reward to low value if the car has any wheels not on the track                                                                                                                                                                                                                                             |
