...
| 3   | calculate_steering_direction_reward | Multiplier | Yes                | Rewards based on steering direction, similar to the modifier above but simpler, rewards based on if steering 'left' or 'right' at given waypoints.                                                                                                                                                             |
| 4   | calculate_car_angle_reward          |            |                    | TODO Car heading relative to track                                                                                                                                                                                                                                                                             |
| 5   | calculate_progress_reward           | Multiplier | Yes                | Rewards based on progress relative to a target step count, if under target full multiplier will be applied, if over target but within range a partial reward will be given based on proximity to target.                                                                                                       |
| 6   | calculate_side_of_track_reward      | Multiplier | Yes                | Rewards based on which third of the track the car is on, 'left', 'middle' or 'right'.                                                                                                                                                                                                                          |
| 100 | terminal_off_track_reward           | Absolute   | NA                 | Set reward to low value if the car has driven off track                                                                                                                                                                                                                                                        |
| 101 | terminal_wheel_off_track_reward     | Absolute   | NA                 | Set reward to low value if the car has any wheels not on the track, having wheels off the track is not necessarily an issue                                                                                                                                                                                    |
| 102 | terminal_reversed_reward            | Absolute   | NA                 | Set reward to low value if the car is in a reversed orientation                                                                                                                                                                                                                                                |
| 103 | terminal_max_steps_check            | Absolute   | NA                 | Set reward to low value if the number of steps has exceeded a pre-defined maximum                                                                                                                                                                                                                              |
